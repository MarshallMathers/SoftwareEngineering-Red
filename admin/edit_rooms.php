      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4" id="room-form" style="display:none">
          <h4 class="d-flex justify-content-between align-items-center mb-3">
            <span class="text-muted">Edit Room</span> <!-- become change form, make invisible until user clicks edit button-->
          </h4>
		  ...
		  <button class="btn btn-primary btn-sm btn-block" style="width:25%;float:right" type="button" onclick="editName()" id="edit-room">Edit name</button>
		  </div><br/> 
		  <label>Room Capacity </label>
			...
			<br/><br/><br/>
			<button class="btn btn-danger btn-sm" id="delete" type="button" onclick="deleteRoom()">Delete room</button>
			<button class="btn btn-success btn-sm" id="add" style="display: none;" type="button" onclick="saveRoom()">Add room</button>
          </form>
        </div>
            ...
            <div class="row">
              <div class="col-md-5 mb-3">
                <select class="custom-select d-block w-100" id="room" required>
                  ...
                  <option value="1">Room 1</option> <!-- these are placeholders for now, later replace them with rooms in database-->
