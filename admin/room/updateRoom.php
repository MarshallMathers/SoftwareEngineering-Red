            ...
            <div class="col-sm-4 text-center">
                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
                    <div class="form-group <?php echo (!empty($room_err)) ? "has-error" : ""; ?>">
                        ...
                        <input type="text" id="room_name" name="room_name" maxlength="20" value="<?php echo $room; ?>" class="form-control" />
                    ...
                    <div class="form-group <?php echo (!empty($capacity_err)) ? "has-error" : ""; ?>">
                        ...
                        <input type="number" id="capacity" name="capacity" min="0" max="999" pattern="[0-9]" value="<?php echo $capacity; ?>" class="form-control" />
                        <span class="help-block" style="color:red;">
